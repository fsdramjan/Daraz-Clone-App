...
import 'package:enayas_app/view/pages/profile/profileDetailsPage.dart';
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Apputils.sizeW10,
                            KText(
                              text: Apputils.isLoggedIn.value == true
                                  ? 'Hello ${AllController.profileC.profileInfo.value.name}, Welcome to Enayas!'
                                  : 'Hello, Welcome to Enayas!',
                        ...
                        Apputils.sizeH30,
                        GestureDetector(
                          onTap: Apputils.isLoggedIn.value == true
                              ? () => Get.to(ProfileDetailsPage())
                              : () => Get.toNamed(AppRouteService.login),
                          child: Card(
                            child: Container(
                              height: 40,
                              width: Get.width / 2,
              ...
              Obx(
                () => Apputils.isLoggedIn.value != true
                    ...
                    : Padding(
                        ...
                        child: primaryButton(
                          onTap: () =>AllController.authC.signout(),
                          height: 35,
                          buttonName: '',
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
